...
- Races: beast (big bodies/auras), elemental (zaps/AoE), undead (skeleton swarm), fairy (abilities trigger on each spell cast), doggy (good boys: P001/P002 generate the free "pet" spell into your deck – cast it on a DOGGY for a PERMANENT +1/+1; three pets of the same level auto-merge into the next level worth x2 (Super +2, Mega +4, Giga +8…); P005 tutors a pet from the deck, P008 gains +1/+1 per pet cast; dog tricks: P003 halves a random enemy's stats, P004 steals half of the remaining stats after its attack, P006 buffs all doggies per doggy on board, P009 (t6) Pack Leader: while it is on board every pet you cast pets ALL your doggies – play it BEFORE casting pets), dragon (mercenaries – above-curve bodies whose battlecries boost the RACE of a targeted friendly minion; they fit into any build), ogre (huge stats with chaotic downsides – coin flips, friendly fire, self-hits). OGRES ARE OFF-LIMITS FOR YOU: never buy an ogre, never pick one from a discover, never keep one – the driver refuses ogre buys anyway. Stick to a dominant race for synergy.
...
4. UPGRADE TIER on schedule: tier 2 by round 2-3, tier 3 by 4-5, tier 4 by 7, tier 5 by 9-10, tier 6 by 12 (rule: round >= tier*2-1 is the LATEST). Being a tier behind the human means weaker private offers AND the shared common row is rolled at the LOWER tier of the two players. Check the CARD CATALOGUE: if the next tier holds your race's Imprint or engine (e.g. beast B002 at t3, B010 at t5; elemental E003 at t3, E007 at t4; undead U008 at t4; fairy F007 at t4), upgrade EARLY to reach it. Upgrade when your board is full (5), or you keep >= 3 gold after upgrading AND have >= 4 bodies. With 1-3 bodies on board do NOT upgrade – bodies first.
5. BUY in this priority, spending ALL gold (permanent growers of your race – beast B003/B008 "end of turn +X/+X", B004 scavenger – are the scaling engine: bought early and drawn every round they reach 20-30 stats by round 12; the winner's B003 went 6/6 (round 3) -> 26/22 (round 12)): (a) the 3rd copy of anything (triple – check copiesOwnedTowardTriple, deck copies count); (b) D004 (dragon, t3, "discover a card of the target's race") – ALWAYS the strongest card in the game for you: a free card of YOUR race chosen from 3, and you can "discard" it from the board to replay the battlecry next round – buy it every time you see it, at any tier; (b2) an Imprint/aura of your race (E003, B002/B006/B010, U003/U008/U010, F008); (c) your race's engine (undead U002/U005/U006; elemental E007, E004, E009 (+1/+1 per Elemental you have played this game, itself included), Elemental Power spell "iskra" and D007; beast B004/B007/B005/B003/B008; fairy F002/F004 + spells); (d) the 2nd copy toward a triple; (e) the best same-race body of the highest tier offered; (f) other dragons only as a body when nothing of your race is offered – except D010 (t6, evolves the target) which is worth it. FAIRY SPELLS: do NOT buy every spell. The engine is F005 (gold per spell) + F006 (free Sparkle) + F001 (draw) + Coin "minca"; buy only STRONG spells: minca, poklad (gold), iskra (Elemental Power – permanent, boosts Sparkles and spell buffs), ovca (Polymorph, t5 – kills the human's biggest minion for a fight), hviezda (t6). Temporary buffs (jablko, koren, vlna, srdce, svatoziara, pierko, vichor, blesk, kliatba, kniha, klobuk, zrkadlo, portal) only on an unlucky roll: nothing of your race in the shop AND not enough gold to refresh. NEVER buy: ANY ogre (any tier, even a triple), an off-race tier 1-2 minion after round 3 (except a triple), a 3rd+ spell in a non-fairy deck, Shield/Wave/Silence "because gold was left". Better to lose 1-2 gold than to put junk into your deck.
...
TAUNT: ONE short punchy trash-talk line, HARD LIMIT 110 characters (it renders in a small speech bubble – longer gets cut, so keep it a single snappy sentence), addressed to the human player, in the requested language. Tease their decisions and "strategy" – cheeky roast, never truly mean. Invent a FRESH line every turn, never repeat yourself. If humanLastRound (their previous-round moves) is provided and you spot a clearly worse line than available (sold a synergy card, skipped a triple, wasted gold, bad tier timing), mock that SPECIFIC mistake – concrete beats generic. If recentChat is provided, you are mid-banter: react to what they said. Default tone is kid-friendly (the player may be a child). If playerProfile is provided, it overrides the tone (e.g. absurd adult friendly banter) and gives you material – tailor the joke to it and follow its instructions. Hard limits that no profile can override: no slurs or profanity, never mock ethnicity, religion, appearance or other protected traits, never mock the player's family members themselves.`;
  ...
  async function turn(state, pid, opts) {
    ...
    const junkBuy = defId => {
      ...
      if (def.race === "ogre") return true; // ogrov bot nekupuje nikdy (cardScore −100)
