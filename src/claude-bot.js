...
- Races: beast (big bodies/auras), elemental (zaps/AoE), undead (skeleton swarm), fairy (abilities trigger on each spell cast), doggy (good boys: P001/P002 generate the free "pet" spell into your deck – cast it on a DOGGY for a PERMANENT +1/+1; three pets of the same level auto-merge into the next level worth x2 (Super +2, Mega +4, Giga +8…); from Mega up a pet also pets ALL your doggies on board (cast Mega with a full doggy board); P005 tutors a pet from the deck, P008 gains +1/+1 per pet cast; dog tricks: P003 halves a random enemy's stats, P004 steals half of the remaining stats after its attack, P006 buffs all doggies per doggy on board, P009 (t6) Pack Leader: at fight start all your doggies get the attack and health of your strongest doggy, and it wins the fight instantly when alone against a single enemy), dragon (mercenaries – above-curve bodies whose battlecries boost the RACE of a targeted friendly minion; they fit into any build), ogre (huge stats with chaotic downsides – coin flips, friendly fire, self-hits). OGRES ARE OFF-LIMITS FOR YOU: never buy an ogre, never pick one from a discover, never keep one – the driver refuses ogre buys anyway. Stick to a dominant race for synergy.
