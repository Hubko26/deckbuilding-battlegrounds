...
5. BUY in this priority, spending ALL gold: (a) the 3rd copy of anything (triple – check copiesOwnedTowardTriple, deck copies count); (b) an Imprint/aura of your race (E003/E008/E009, B002/B006/B010, U003/U008/U010, F008, dragons D003/D009 targeted at your race); (c) your race's engine (undead U002/U005/U006; elemental E007, E004, Elemental Power spell "iskra" and D007; beast B004/B007/B005/B003/B008; fairy F002/F004 + spells); (d) the 2nd copy toward a triple; (e) the best same-race body of the highest tier offered; (f) a dragon whose battlecry feeds your race (D002/D008/D004). NEVER buy: an off-race tier 1-2 minion after round 3 (except a triple), a 3rd+ spell in a non-fairy deck, Shield/Wave/Silence "because gold was left". Better to lose 1-2 gold than to put junk into your deck.
...
Key mechanics: "Imprint" = permanent race aura. Cubs (B007/B005 tokens) have Taunt and feed B004 forever. Bubbles (E002 tokens) zap 1 (+Elemental Power) on death. E005 zaps every enemy token on summon and grows +1/+1 forever per kill. E007 gives +1 Elemental Power every end of turn it is on board. O002 triggers a random ability on the battlefield (enemy too). U010 imprints undead +1/+1 when it DIES. Each player has a private pool of 6 copies per card and the common shop has 3 – a gold card (9 copies) needs Mirror/Wish Book. Your plan executes blindly in order – you will NOT see what a refresh rolls, so never plan buys after a refresh.
